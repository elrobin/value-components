...
This is document reproduces the figures produced in the study 'A value creation model for science-society interconnections: Archetypal analysis combining publications, survey and altmetric data' authored by I. Ramos-Vielba, N. Robinson-Garcia /& R. Woolley. The preprint version of this study is available at [doi:10.31235/osf.io/tkzc5](https://doi.org/10.31235/osf.io/tkzc5). Data is available at [doi:10.5281/zenodo.4767452](http://doi.org/10.5281/zenodo.4767452). Code scripts are available in a (GitHub repository)[https://github.com/elrobin/value-components].

# Data import and processing

Data is imported from Zenodo. It includes 6174 observations and 13 variables.
The 38 cases removed correspond to observations from researchers who were categorised as Multidisciplinary.
...
atypes <- parameters(arc.model) # extract parameters
...
Co-occurrence term maps overlaying alpha scores for researchers' scientific output is available online here: (https://tinyurl.com/allarchetypes)[https://tinyurl.com/allarchetypes]. Below find the code to extract the alpha score of each observation for the three archetypes:
...
Co-occurrence term maps overlaying alpha scores for researchers' scientific output is available online here: (https://tinyurl.com/stemarchetypes)[https://tinyurl.com/stemarchetypes].
...
Co-occurrence term maps overlaying alpha scores for researchers' scientific output is available online here: (https://tinyurl.com/ssharchetypes)[https://tinyurl.com/ssharchetypes].
...
Co-occurrence term maps overlaying alpha scores for researchers' scientific output is available online here: (https://tinyurl.com/biomedarchetypes)[https://tinyurl.com/biomedarchetypes].
